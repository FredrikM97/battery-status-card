...
import { BatteryStatusCardConfig, ColorThreshold } from '../types';
...
export class BatteryStatusCard extends LitElement implements LovelaceCard<BatteryStatusCardConfig> {
  ...
  private _getFilteredEntities(): string[] {
    ...
    entities = filterEntities(this.hass, entities, this._config.include, this._config.exclude);
...
declare global {
  interface HTMLElementTagNameMap {
    'battery-status-card': BatteryStatusCard;
  }
}
